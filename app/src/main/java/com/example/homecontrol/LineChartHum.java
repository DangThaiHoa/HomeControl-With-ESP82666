...
public class LineChartHum extends AppCompatActivity {

    LineChart lineChart;
    String path = "HomeControl/ESP8266/ChartData/";
    DatabaseReference refChartHum, refError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_chart_hum);

        lineChart = findViewById(R.id.chart_hum);
        ...
        refError.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(getError.equals("Read/Connect")){
                    ...
                    refChartHum.addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
    ...
    private void showChart(ArrayList<Entry> humArrayList) {

        LineDataSet lineDataSetTemp = new LineDataSet(humArrayList,"Độ Ẩm");
        ...
        lineChart.getDescription().setText("Biểu Đồ Độ Ẩm");
